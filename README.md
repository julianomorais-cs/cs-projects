...
- Pensamento Computacional e Resolução de Problemas: [Curso Completo de Python - do Zero ao Avançado (Masterclass)](https://youtu.be/-VeVq64Fgw0?feature=shared) por **Boson Treinamentos**; [Python Full Course for Free](https://youtu.be/ix9cRaBkVe0?feature=shared) por **Bro Code**; [Projetos em Phyton](https://github.com/KerubinSM5/Pensamento-Computacional) por **Kelvin Martins** 
  
- Bootcamp I:

#### - Estudos adicionais:  
- [Linguagem  Go: Coomeçando Zero](https://www.youtube.com/live/kdneT0pDeN0?feature=shared) por **Full Cycle**
